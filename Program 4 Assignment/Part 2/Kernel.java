            ...
            case INTERRUPT_SOFTWARE: // System calls
                switch (cmd) {
                    ...
                    case WAIT:
                        ...
                        // If the condition is equal to tid,
                        // put the current thread into sleep in the waitQueue
                        return waitQueue.enqueueAndSleep(myTcb.getTid());

                    case EXIT:
                        // Parent id
                        myTcb = scheduler.getMyTcb();
                        // If the condition is equal to parent's tid,
                        // wake up the thread and then delete it
